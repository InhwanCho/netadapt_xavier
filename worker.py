...
def worker(args):
    ...
    network_utils = networkUtils.__dict__[args.arch](model, args.input_data_shape, args.dataset_path,args.dataset, args.finetune_lr)
    print('network check')
    ...
    print('start Choose the filters')                                                          
    # Choose the filters.
    ...
    print("kd : ", args.kd)
    if args.kd == 'kd':
        fine_tuned_model = network_utils.fine_tune_v2(model, simplified_model, args.short_term_fine_tune_iteration)
    else:
