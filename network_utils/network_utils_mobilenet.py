...
class networkUtils_mobilenet(NetworkUtilsAbstract):
    ...
    def __init__(self, model, input_data_shape, dataset_path, dataset, finetune_lr=1e-3):
        '''
            ...
            Need to be implemented:
                (1) finetune/evaluation data loaders
                (2) loss function
                (3) optimizer
    ...
    def fine_tune_v2(self, T_model, model, iterations, print_frequency=100):
        ...
        for i in range(iterations):
            ...
            # Ground Truth Loss
            hard_target_loss = F.cross_entropy(pred, target_onehot, reduction='mean')
...
def mobilenet(model, input_data_shape, dataset_path, dataset,finetune_lr=1e-3):
    return networkUtils_mobilenet(model, input_data_shape, dataset_path, dataset,finetune_lr)